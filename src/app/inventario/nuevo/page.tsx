...
export default function NuevoProductoPage() {
  ...
  const [form, setForm] = useState({
    ...
    // de "proximos servicios" del lubricentro.
    ...
    try {
      ...
      try {
        guardado = await saveProducto({
          ...
          servicio_intervalo_km:
            form.tipo_producto === "servicio" && form.servicio_intervalo_km
              ? Number(form.servicio_intervalo_km)
              : null,
          servicio_intervalo_meses:
            form.tipo_producto === "servicio" && form.servicio_intervalo_meses
              ? Number(form.servicio_intervalo_meses)
              : null,
    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-xl shadow p-6 max-w-5xl">
        <form className="space-y-6" onSubmit={handleSubmit} noValidate>
          ...
          {/* Intervalo de mantenimiento — solo para servicios del lubricentro */}
          {form.tipo_producto === "servicio" && (
            <div className="rounded-xl border border-[#4FAEB2]/30 bg-[#4FAEB2]/5 p-4">
              <p className="text-sm font-semibold text-slate-700">Intervalo de mantenimiento</p>
              <p className="mt-0.5 text-xs text-slate-500">
                Cada cuánto se repite este servicio. Con esto el sistema avisa a qué vehículos les
                toca. Vence por lo que ocurra primero. Dejalo vacío si no aplica.
              </p>
          ...
          <div className="border-t border-slate-100 pt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-5">
              ...
              {/* Ubicación principal — oculta: heredado del baseline; revisar con Leguizcard.
          ...
          {/* Método de valuación — oculto: heredado del baseline; revisar con Leguizcard.
